...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <!-- LOGO -->
  <tr>
    <td bgcolor="#002A53" align="center">
  ...
  <!-- HERO -->
  <tr>
    <td bgcolor="#002A53" align="center" style="padding: 0px 10px 0px 10px;">
      ...
      <!-- COPY -->
        ...
        <tr>
          <td bgcolor="#ffffff" align="left" style="padding: 10px 30px 10px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
            <p style="margin: 0;"><a href="{{ $website_link }}" target="_blank" style="color: #3AB049;">{{ $website_name }}</a></p>
          </td>
        </tr>
        @endif
        <tr>
          <td bgcolor="#ffffff" align="left" style="padding: 0px 30px 20px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 15px; font-weight: 400; line-height: 25px;">
            <p style="margin: 0;">Cheers,<br>{{ $project_name }} Team<br><span style="font-size: 12px; color: #3AB049;">{{ $support_email }}<br>{{ $support_phone }}</span></p>
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td bgcolor="#f4f4f4" align="center" style="padding: 5px 10px 0px 10px;">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
        <!-- HEADLINE -->
        <tr>
          <td bgcolor="#3AB049" align="center" style="padding: 10px 30px 10px 30px; border-radius: 4px 4px 4px 4px; color: #002A53; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
            <!-- <h2 style="font-size: 20px; font-weight: 400; color: #111111; margin: 0;">Need more help?</h2> -->
            <p style="margin: 0; font-size: 12px; font-weight: 200;">{{ $project_name }}. Powered by
              <a href="{{ $powered_by_link }}" target="_blank" style="color: #FFF;">{{ $powered_by_name }}</a>
            </p>
          </td>
        </tr>
      </table>
